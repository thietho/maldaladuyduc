<div id="listpoduct">
    ...
    <div class="ben-left product">
        <div class="productcell" ref="<?php echo $media['imagetpreview']?>"
            ...
            <table>
                <tr class="product-list-image">
                    <td>
                        ...
                        <a class="islink" href="<?php echo $media['link']?>"
                           title="<?php echo $media['title']?><?php if($media['code']!="") echo ' - '.$media['code']?>"><img
                                src="<?php echo $media['imagethumbnail']?>" class='ben-center'
                                alt="<?php echo $media['title']?>" title="<?php echo $media['title']?>"/></a>
                    ...
                    <td>
                        <div align="center">
                            <a href="<?php echo $media['link']?>"
                               title="<?php echo $media['title']?><?php if($media['code']!="") echo ' -
                            '.$media['code']?>">
                            <h6>
                        ...
                        <div align="center" class="product-pricepromotion">
                            ...
                            <?php echo $this->string->numberFormate($media['pricepromotion'])?> <?php echo $this->
                        ...
                        <div align="center">
                            ...
                            <input type="button" class="cart-order" value="Đặt hàng"
                                   onclick="cart.add('<?php echo $media['mediaid']?>')"/>
                        </div>
                    </td>
                </tr>
            </table>
