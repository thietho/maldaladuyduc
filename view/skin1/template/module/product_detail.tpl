...
<div class="ben-post">
    <div class="ben-left product-left">
        ...
        <a class="islink" href="<?php echo $media['link']?>"><img src='<?php echo $media[' imagethumbnail']?>'
            class='ben-center' /></a>
        <?php }?>
        ...
        <div class="product-mainimage">
            <table>
                <tr valign="middle">
                    <td id="product-preview" height="250px" align="center"><a class="zoom"
                                                                              href="<?php echo $post['imagepreview']?>"><img
                                    src="<?php echo $post['imagethumbnail']?>" width="100%"/></a></td>
                </tr>
            </table>
        ...
        <div id="ben-galary" class="ben-center">
            <table>
                <tr>
                    <td style="width:14px">
                        <img class="ben-link" id="ben-prev"
                             src="<?php echo HTTP_SERVER.DIR_IMAGE?>galary_button_prev.png"
                        ...
                        <div style="overflow:hidden;width:248px;margin:0 auto;">
                            <table id="ben-scroll">
                                <tr>
                                    ...
                                    <td>
                                        <img id="icon-<?php echo $key?>" class="ben-icon-item"
                                             src="<?php echo $val['icon']?>"/>
                                    </td>
                                    <?php } ?>
                                </tr>
                            </table>
                    ...
                    <td style="width:14px">
                        <img class="ben-link" id="ben-next"
                             src="<?php echo HTTP_SERVER.DIR_IMAGE?>galary_button_next.png"/>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="display:none">
            ...
            <div id="preview-<?php echo $key?>">
                <a class="zoom" href="<?php echo $val['imagepreview']?>"><img
                            src="<?php echo $val['imagethumbnail']?>"/></a>
            </div>
            <?php } ?>
        </div>
    ...
    <div class="ben-right product-right">
        ...
        <div class="ben-post-body">
            ...
            <table>
                ...
                <tr>
                    <td width="100px"><strong>Giá:</strong></td>
                    <td>
                        <?php echo $this->
                        string->numberFormate($post['price'])?> <?php echo $this->document->setup['Currency']?>
                ...
                <tr>
                    <td>Giá giảm</td>
                    <td><?php echo $this->string->numberFormate($post['pricepromotion'])?> <?php echo $this->document->setup['Currency']?></td>
                </tr>
                <?php } ?>
            </table>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <p class="ben-khuyenmai"><a
                                onclick="xemkhuyenmai('<?php echo $val['makhuyenmai']?>')"><?php echo $val['tenkhuyenmai']?></a>
                    </p>
                    <?php } ?>
                </td>
                ...
                <td class="number">
                    <?php if($val['price']!=0){ ?>
                    <?php echo $this->string->numberFormate($val['price'])?> <?php echo $this->
                    document->setup['Currency']?>
                    <?php } ?>
                </td>
                <td class="number">
                    <?php if($val['pricepromotion']!=0){ ?>
                    <?php echo $this->string->numberFormate($val['pricepromotion'])?><?php echo $this->
                    document->setup['Currency']?>
                    <?php } ?>
                </td>
                <td><input type="button" class="ben-button ben-center"
                           onclick="cart.add('<?php echo $val['mediaid']?>')" value="Đặt hàng"></td>
            </tr>
            <?php } ?>
